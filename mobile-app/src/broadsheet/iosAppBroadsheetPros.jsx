...
function BSTrainerToday({ onProfile, sheet, goCalendar, goRadio, onOpenReviews, onWidgetOpen = () => {}, onOpenHabits = () => {}, onOpenScore = () => {}, onWatchLive = () => {}, tweaks = {}, setTweak = () => {} }) {
  ...
  return (
    <BSPage>
      <BSMasthead
        compact
        title={<img src={`${import.meta.env.BASE_URL}shape-wordmark.png`} alt="Shape" style={{ display: 'block', margin: '6px auto -2px', height: 60, width: 'auto', filter: 'brightness(0) invert(1)' }} />}
    ...
    <Wrapper>
      ...
      {loading ? (
        ...
        <div style={{ padding: `40px ${t.padX}px` }}>
          ...
          <div style={{ fontFamily: t.DISPLAY || t.DISPLAY, fontSize: 14, color: t.INK70, lineHeight: 1.5 }}>

// Supabase session refresh — runs on every request via proxy.ts.
// Reads the auth cookies, asks Supabase to refresh the session if needed,
// and writes any updated cookies back onto the response.

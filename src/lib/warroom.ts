  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Migration 2026-07-13-adjust-regeneration.sql APPLIED + verified live (owner ran it 2026-07-13): regenerate_client_workouts grants anon=f / authd=t / svc=t, notify_on_client_workout carries the shape.adjust_regen quiet-flag, client_workouts_notify trigger attached', status: 'done' },

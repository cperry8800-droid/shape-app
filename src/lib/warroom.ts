  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'OWNER: run supabase-migrations/2026-07-18-user-activity-live.sql (additive + idempotent; raw link on the build PR). Until applied, every live-progress call is a SILENT NO-OP and both surfaces render exactly today\'s UI', status: 'manual' },

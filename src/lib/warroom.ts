  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Mobile parity: the app\'s invited waitlist "Book now" (iosAppBroadsheetClient) fires the per-role ONE-TIME purchase (doBookOneTime → checkout-session payment mode, server-authoritative price) with Subscribe /mo + Decline alongside — matches the website first-dibs trio (#1498)', status: 'done' },
      ],
    },
    {

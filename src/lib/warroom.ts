  ...
  return [
    {
      ...
      items: [
        ...
        { label: 'BUILD 4/9 — live-coach-channel (after 1): user_activity_live_coach (30-min TTL, 8KB bound, owner for-all + coach-read RLS) + live_clear() + bsLiveCoachPayload + dual-push writer (null coach payload DELETES the row) + both consumers (active revocation clear) + the full denial matrix. ⚠ OWNER migration 2026-07-19-user-activity-live-coach.sql', status: 'pending' },

  ...
  return [
    {
      ...
      items: [
        ...
        { label: 'BUILD 2/9 — variance-band: bsVarianceBand/Copy + get_roster_weekly_adherence (definer; raises >100 ids; shape_user_tz; EXISTS-not-join) + roster VARIABLE chip + Case File line + web line. No new routes; members never see it. ⚠ OWNER migration 2026-07-19-roster-weekly-adherence.sql lands with this PR', status: 'pending' },

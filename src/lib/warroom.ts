...
function buildChecklist(config: ConfigGroup[], mobileBuild = false): ChecklistSection[] {
  ...
  return [
    ...
    {
      section: 'Redesign wave: Session Details · Home · Feed · Profile (2026-07-03/04)',
      items: [
        ...
        { label: 'Coach "Signal" profile (BSSignalCoachProfile) Route Card parity — the ready-made next wave: same rail/stations/ledger/press-credit/redaction grammar with the coach-ladder tier as heat; the shared components already carry the ledger/still variants, so it needs the credential-header + tier-as-heat pass', status: 'pending' },

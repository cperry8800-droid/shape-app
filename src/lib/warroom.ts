  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Strength / e1RM progression (#2): estimated 1RM + Progressing/Holding/Stalled engine, dedicated Strength page, PR-row e1RM, coach lift e1RM — /api/client/strength endpoint, get_client_lifts widens with e1rm via 2026-06-25-client-lifts-e1rm.sql', status: 'done' },

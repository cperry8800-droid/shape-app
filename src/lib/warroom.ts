  ...
  return [
    {
      ...
      items: [
        ...
        { label: 'Leaked-password protection (HaveIBeenPwned) — UNBLOCKED: org is on Supabase Pro (upgraded 2026-06-23). One-click owner enable: Auth → Passwords → "Prevent use of leaked passwords" (or Management API config/auth password_hibp_enabled:true). Toggle not yet flipped', status: 'manual' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Leaked-password protection (HaveIBeenPwned) — Auth → Passwords → "Prevent use of leaked passwords". Supabase Pro now active (2026-06-23) — a one-click owner enable, not yet flipped', status: 'manual' },

  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Website invited "Book now" routes to the per-role one-time purchase (trainer → /purchase kind=booking, nutritionist → /purchase kind=meal_plan) instead of the subscribe link; the webhook booked-flip covers both payment and subscription modes', status: 'done' },
      ],
    },
    {

  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Migration 2026-07-13-adjust-regeneration.sql — regenerate_client_workouts RPC + quiet notify trigger. OWNER: run it (raw link on the PR); code degrades cleanly until applied', status: 'manual' },

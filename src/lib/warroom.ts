  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Website parity for the check-in kit (check-in form + measurements/photos on client pages; check-in/health/measurements on coachClientDetail)', status: 'manual' },

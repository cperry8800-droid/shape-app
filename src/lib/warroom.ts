  ...
  return [
    {
      ...
      items: [
        ...
        { label: 'BUILD 3/9 — live-cooking-detail (after 1): kind-dispatch validator + bsCookingPayload (strict kcal predicate) + provenance-live writer + server-authoritative audience withdrawal + boost-sheet cooking line + expired-event guard. ⚠ OWNER migration 2026-07-19-user-activity-live-expiry-rls.sql', status: 'pending' },

  ...
  return [
    {
      ...
      items: [
        ...
        { label: 'BUILDS 8-9/9 — The Cycle C→D: C coach (Case File CYCLE station + shared-overview leg; absence, never a padlock — a coach must not be able to distinguish never-opted-in from not-shared) → D website parity', status: 'pending' },

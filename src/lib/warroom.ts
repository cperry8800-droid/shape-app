  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'OWNER: run supabase-migrations/2026-07-10-ai-audit-undo-claim.sql (claim_ai_action_undo + release_ai_action_undo on ai_audit_log) — undo stays on the legacy non-atomic order until applied', status: 'manual' },

  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Run migration 2026-07-09-provider-monthly-offer.sql on Supabase — adds monthly_offer jsonb to trainers + nutritionists (idempotent; the Listing/editor degrade cleanly until applied)', status: 'manual' },

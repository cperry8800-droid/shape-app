  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Strength / e1RM progression (#2) — coach lift e1RM: pending get_client_lifts widening (2026-06-25-client-lifts-e1rm.sql) being (re-)applied', status: 'manual' },
        { label: 'Migration: 2026-06-25-client-lifts-e1rm.sql (widens get_client_lifts with e1rm; re-run after the payload/completed-set fixes)', status: 'manual' },

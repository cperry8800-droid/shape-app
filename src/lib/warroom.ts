  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: '⚠ OWNER MIGRATION — supabase-migrations/2026-07-26-purchase-plan-snapshot.sql (#1837 merged — the file IS on main now; run it on Supabase). Idempotent and safe to RE-RUN: the backfill fills any row written while PostgREST still reported the column missing. Code degrades cleanly until applied (the purchase records without a snapshot and logs at error level naming this file)', status: 'manual' },

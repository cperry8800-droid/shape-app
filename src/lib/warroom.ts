  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'MIGRATIONS (created, idempotent + RLS): 2026-06-22-consent-log.sql (append-only owner-RLS), 2026-06-22-age-verification.sql (date_of_birth/over_18 + set_over_18 trigger), 2026-06-22-account-deletions.sql (service-role only, no FK to auth.users). OWNER: run on Supabase', status: 'manual' },

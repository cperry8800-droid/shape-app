  ...
  return [
    {
      ...
      items: [
        ...
        { label: 'BUILD 1/9 — live-progress-web: canonical liveProgress.mjs split + THE LIVE STATION on coachClientDetail (browser realtime under shipped RLS, evented/expiry/A→B hygiene) + chat presence line. No migration. FOUNDATION for cooking + coach-channel — build FIRST, on Opus, plan verbatim', status: 'pending' },

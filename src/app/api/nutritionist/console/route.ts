...
export async function GET() {
  ...
  if (providerId == null) {
    return NextResponse.json({ isNutritionist: false, clients: [], focusByClient: {}, itemsByClient: {} });
  }
  ...
  return NextResponse.json({ isNutritionist: true, clients, focusByClient, itemsByClient });
}

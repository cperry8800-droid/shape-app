      ...
      {nutritionist ? (
        <section className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-6">
          ...
          <div className="mt-5 rounded-lg border border-neutral-800 bg-neutral-950/40 p-4 flex items-center justify-between gap-4 flex-wrap">
            <div>
              <h3 className="text-sm font-medium">Client review desk</h3>
              <p className="text-xs text-neutral-500 mt-1">
                Review client adherence sessions, logged training days, sensor context, and notes.
              </p>
            </div>
            <Link

...
export default async function TrainerDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <section className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-6">
          ...
          <div className="mt-3 rounded-lg border border-neutral-800 bg-neutral-950/40 p-4 flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1">
                Generate coach-editable workouts, attach exercise demos, and define auto-adjust rules.
              </p>
            </div>
            <Link
      ...
      <CoachCompliancePanel role="trainer" subscribers={subscribers} overlays={overlays} />
      ...
      <CoachClientCRM role="trainer" subscribers={subscribers} />

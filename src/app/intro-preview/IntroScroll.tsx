      ...
      >
        <div className="flex items-center justify-center gap-2.5 text-[1.1rem] font-extralight uppercase leading-none tracking-[0.28em] text-white md:gap-3 md:text-[clamp(1.3rem,2.6vw,2rem)]">
          ...
          <img
            ...
            alt="Shape"
            className="relative h-[0.73em] w-auto [filter:brightness(0)_invert(1)] md:-top-[2px] md:h-[0.83em]"
          />
        </div>
        <button
          type="button"
      ...
      >
        ...
        >
          ...
          <img
            src="/logo-text-trimmed.png"
            alt="Shape"
            className="relative top-[0.5px] h-[0.83em] w-auto [filter:brightness(0)_invert(1)] group-hover:[filter:brightness(0)] md:top-0 md:h-[0.7rem]"
          />
          <span>→</span>
        </a>
        <a

    ...
    <main className="fixed inset-0 bg-black text-white">
      ...
      >
        ...
        <button
          type="button"
          onClick={goToScene2}
          className="inline-flex items-center justify-center border-[0.5px] border-white bg-transparent px-5 py-2 text-[0.58rem] font-light uppercase tracking-[0.12em] text-white transition-all hover:bg-white hover:text-neutral-950 md:border md:px-8 md:py-3 md:text-[0.74rem] md:font-medium"
        >
          Get Started →
        </button>
      </div>

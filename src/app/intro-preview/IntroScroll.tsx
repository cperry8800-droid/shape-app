...
export default function IntroScroll() {
  ...
  return (
    <main className="fixed inset-0 bg-black text-white">
      ...
      <div
        className="absolute inset-x-0 top-1/2 -translate-y-1/2 z-10 flex flex-col items-center gap-5 px-6 text-center transition-opacity duration-[1000ms] ease-out"
        style={{
          opacity: scene === 1 ? 1 : 0,

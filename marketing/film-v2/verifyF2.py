...
for nm,T in starts.items():
    a=frame(T-0.15); b=frame(T+0.45); c=frame(T+0.55)
...
f=frame(bar(14)+2.0); chk('radio play glyph',teal(f[2040:2130,560:700])>400,f'teal in the glyph box {teal(f[2040:2130,560:700])}')

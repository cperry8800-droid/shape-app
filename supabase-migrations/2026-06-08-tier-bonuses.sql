...
-- they break into each EARNED tier (no free bonus for Base — you start there):
--   Tempo 500 · Form 1,000 · Peak 2,000 · Legend 4,000
-- (Same thresholds for the coach ladder — Pro/Elite/Master/Icon — so coaches get
--  the bonuses too.)
--
...
-- per-tier source_id, so a bonus is awarded exactly once and bonuses never
-- re-trigger each other. Call award_tier_bonuses() after points change / on app
-- load. Run on Supabase.

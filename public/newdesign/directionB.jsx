      ...
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(26,22,18,0.9)", backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)", borderBottom: "1px solid rgba(242,237,228,0.08)" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 72px", gap: 32 }}>
          ...
          <nav style={{ display: "flex", gap: 22, alignItems: "center" }}>
            ...
            <NavTab label="App" href="GetApp.html" />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "end", marginBottom: 64 }}>
            ...
            <div style={{ paddingBottom: 12 }}>
              ...
              <div style={{ display: "flex", gap: 12, marginTop: 36 }}>
                ...
                <a href="SignupTrainer.html" style={{ background: "transparent", color: INK, border: "1px solid rgba(242,237,228,0.2)", padding: "16px 26px", borderRadius: 6, fontWeight: 500, fontSize: 14.5, fontFamily: sans, cursor: "pointer", textDecoration: "none", display: "inline-block" }}>I'm a trainer</a>
              </div>
            </div>
          </div>
    ...
    return (
      <section style={{ padding: "120px 72px", background: PAPER, borderTop: "1px solid rgba(242,237,228,0.1)" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 380px", gap: 100, alignItems: "center" }}>
          ...
          <div style={{ position: "relative", width: 380, margin: "0 auto" }}>
            <div style={{ position: "absolute", inset: "-40px -60px", background: "radial-gradient(ellipse at center, rgba(10,197,168,0.12), transparent 70%)", filter: "blur(20px)", zIndex: 0 }} />
            <div style={{ position: "relative", zIndex: 1, background: "#000", borderRadius: 48, padding: 10, boxShadow: "0 40px 80px -30px rgba(242,237,228,0.35), 0 0 0 1px rgba(242,237,228,0.08)" }}>
              <div style={{
                minHeight: 720,
                position: "relative",
    ...
    return (
      <section style={{ padding: "120px 72px", background: PAPER, borderTop: "1px solid rgba(242,237,228,0.1)" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 380px", gap: 100, alignItems: "center" }}>
          ...
          <div style={{ position: "relative", width: 380, margin: "0 auto" }}>
            <div style={{ position: "absolute", inset: "-40px -60px", background: "radial-gradient(ellipse at center, rgba(10,197,168,0.10), transparent 70%)", filter: "blur(20px)", zIndex: 0 }} />
            <div style={{ position: "relative", zIndex: 1, background: "#070707", borderRadius: 48, padding: 10, boxShadow: "0 40px 80px -30px rgba(242,237,228,0.35), 0 0 0 1px rgba(242,237,228,0.08)" }}>
              <img
                src="/newdesign/home%20page%20new.png"
      ...
      <section style={{ padding: "120px 72px", position: "relative", overflow: "hidden", color: INK }}>
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 80, alignItems: "center", position: "relative" }}>
          <div>
            ...
            <p style={{ fontFamily: sans, fontSize: 17, lineHeight: 1.55, color: "rgba(242,237,228,0.85)", maxWidth: 460 }}>

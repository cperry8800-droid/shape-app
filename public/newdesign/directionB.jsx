  ...
  function Hero() {
    return (
      <section style={{ padding: "100px 40px 80px", position: "relative", overflow: "hidden" }}>
        <div aria-hidden style={{ position: "absolute", inset: 0, backgroundImage: "url('/Home%20page%201.png')", backgroundSize: "cover", backgroundPosition: "center 30%", pointerEvents: "none" }} />

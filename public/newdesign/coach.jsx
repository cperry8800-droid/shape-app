      ...
      <CoReveal>
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 48, textAlign: "center" }}>
            <a href={dashShellHref("TrainerDashboard.html")} style={{ fontFamily: mono, fontSize: 12, letterSpacing: "0.12em", textTransform: "uppercase", color: TEAL, borderBottom: "1px solid rgba(10,197,168,0.3)", paddingBottom: 3 }}>See the full dashboard →</a>
          </div>
        </div>
      </CoReveal>
    </section>
...
function TrainerFAQ() {
  const faqs = [
    ...
    { q: "How fast do payouts land?", a: "Weekly, direct to your bank — usually Monday. Need it faster? Instant payouts are available any day." },

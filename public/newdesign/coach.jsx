...
function TrainerHero() {
  return (
    <section style={{ padding: "150px 72px 100px", position: "relative", overflow: "hidden", minHeight: "88vh", display: "flex", alignItems: "center" }}>
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", position: "relative", width: "100%" }}>
        <div style={{ maxWidth: 900 }}>
          ...
          <div style={{ marginTop: 40, display: "flex", gap: 28, fontFamily: mono, fontSize: 12, color: "rgba(242,237,228,0.55)", flexWrap: "wrap" }}>
            <span>✓ No monthly fee — 15% only on earnings</span>
      ...
      <CoReveal>
        <div className="co-earn" style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: 80, alignItems: "center" }}>
          <div>
            ...
            <h2 style={{ fontFamily: serif, fontSize: "clamp(44px, 5vw, 78px)", letterSpacing: "-0.04em", fontWeight: 300, margin: "0 0 28px", lineHeight: 0.96, color: INK }}>Set your price. <em style={{ fontStyle: "italic", fontWeight: 600, color: TEAL }}>Keep 85% of it.</em></h2>
      ...
      <CoReveal>
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 48, textAlign: "center" }}>
            <a href="TrainerDashboard.html" style={{ fontFamily: mono, fontSize: 12, letterSpacing: "0.12em", textTransform: "uppercase", color: TEAL, borderBottom: "1px solid rgba(19,194,168,0.3)", paddingBottom: 3 }}>See the full dashboard →</a>
          </div>
        </div>
      </CoReveal>
    </section>
...
function TrainerFAQ() {
  const faqs = [
    ...
    { q: "What does Shape cost trainers?", a: "No monthly dues, no listing fees. Shape takes a 15% platform fee on what your clients pay you — so you only pay when you earn. Standard card processing is separate." },

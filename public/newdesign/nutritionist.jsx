    ...
    <section style={{ padding: "150px 72px 100px", position: "relative", overflow: "hidden", minHeight: "88vh", display: "flex", alignItems: "center" }}>
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", position: "relative", width: "100%" }}>
        <div style={{ maxWidth: 900 }}>
          <div style={{ fontFamily: mono, fontSize: 12, letterSpacing: "0.3em", textTransform: "uppercase", color: TEAL_BRIGHT, marginBottom: 28 }}>For nutritionists</div>
      ...
      <NuReveal>
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 48, textAlign: "center" }}>
            <a href="NutritionistDashboard.html" style={{ fontFamily: mono, fontSize: 12, letterSpacing: "0.12em", textTransform: "uppercase", color: TEAL, borderBottom: "1px solid rgba(19,194,168,0.3)", paddingBottom: 3 }}>See the full dashboard →</a>
          </div>
        </div>
      </NuReveal>
    </section>

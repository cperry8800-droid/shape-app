...
const TCP_FILTERS = (n) => [["eyes", "At-risk · " + n, true], ["all", "All"], ["new", "New"], ["ontrack", "On track"]];
        ...
        {tab === "shared" ? (
          ...
          <>
            ...
            {loading
              ...
              : <DashRosterTable triage={triage} role="trainer" filter={flt} query={q} sort={sort} sortDir={sortDir} onSort={onSort} />}
          </>
        )}
      </Card>
    </DashPage>

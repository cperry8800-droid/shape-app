...
function RadioHero() {
  ...
  return (
    <section style={{ padding: "72px 72px 56px 150px", position: "relative", overflow: "hidden", minHeight: "calc(100vh - 109px)", boxSizing: "border-box", display: "flex", alignItems: "center", background: "transparent" }}>

      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.6fr 1fr", gap: 20 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <Card>
            ...
            <VideoUpload video={video} onPick={pickVideo} onClear={clearVideo} hint="Upload a clip showing how to run this session — form cues, setup, transitions. Clients see it on their phone next to the workout." />
          </Card>
        </div>

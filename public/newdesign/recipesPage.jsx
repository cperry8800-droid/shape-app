...
// the one source. Unparseable → null, and the guard in tests/recipe-menu.test.mjs
// asserts every catalog recipe parses — a recipe with no readable time would
// otherwise vanish from a page whose whole structure is "by time".

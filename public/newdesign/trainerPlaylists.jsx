...
const TRAINER_PLAYLISTS = [
  {
    ...
    trackCount: 28,
    duration: "2h 14m",
    cover: "linear-gradient(135deg, #7a2a2a 0%, var(--sh-ground, #1a1612) 70%)",
    accent: "#d84a4a",
  ...
  },
  {
    ...
    trackCount: 31,
    duration: "2h 06m",
    cover: "linear-gradient(135deg, #2a3a6a 0%, var(--sh-ground, #1a1612) 70%)",
    accent: "#6a8cff",
  ...
  },
  {
    ...
    trackCount: 18,
    duration: "1h 12m",
    cover: "linear-gradient(135deg, #6a4a1c 0%, var(--sh-ground, #1a1612) 70%)",
    accent: "#f2a94e",
  ...
  },
  {
    ...
    trackCount: 36,
    duration: "2h 32m",
    cover: "linear-gradient(135deg, #5a1c4a 0%, var(--sh-ground, #1a1612) 70%)",
    accent: "#e86bd8",
  ...
  },
  {
    ...
    trackCount: 48,
    duration: "3h 24m",
    cover: "linear-gradient(135deg, #1c4a5a 0%, var(--sh-ground, #1a1612) 70%)",
    accent: "#4ab8d8",

  ...
  const widgets = [
    ...
    { key: "path", title: "Path to Icon", size: "half", render: () => (
      <Card style={{ background: "rgba(var(--sh-accent2-rgb, 10,197,168),0.06)", border: "1px solid rgba(var(--sh-accent2-rgb, 10,197,168),0.25)" }}>
        ...
        <div style={{ fontSize: 14, lineHeight: 1.55, color: "rgba(var(--sh-ink-rgb, 242,237,228),0.85)" }}>9,660 more points. Top levers: add 10 clients (+500), hit 95% log adherence (+330), publish 2 plans (+390).</div>
      </Card>
    ) },

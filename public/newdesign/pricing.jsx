...
{ q: "Do trainers and nutritionists pay to be on Shape?", a: "No. Shape is free for trainers and nutritionists to join — no monthly fee, no setup fee, no listing fee. A small platform fee is deducted from each transaction to cover payments, scheduling, the app, the community, and Radio." },

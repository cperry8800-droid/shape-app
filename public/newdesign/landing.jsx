  ...
  return (
    <a
      ...
      <h2 style={{ fontFamily: serif, fontSize: 42, letterSpacing: "-0.025em", fontWeight: 400, margin: 0, lineHeight: 1.02 }}>
        {isRadio ? <img src="/newdesign/SHape%20radio%20logo.png" alt="Shape Radio" style={{ height: 96, width: "auto", display: "block", mixBlendMode: "screen", marginLeft: -8 }} /> : role.title}
      </h2>

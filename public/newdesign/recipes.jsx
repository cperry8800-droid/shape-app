...
const RECIPES_USDA = [
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Meat",
    time: "45 min", servings: 4, kcal: 490,
    macros: { p: 38, c: 52, f: 14 },
    tags: ["High protein","Bowl","Meal prep"],
    hero: "linear-gradient(135deg, #c65d3b 0%, #4a6b32 55%, #1a1612 100%)",
    note: "Grilled pork, quick pickles and quinoa in one loaded bowl.",
    ingredients: [
      "1 lb pork tenderloin, cubed (550 kcal)",
      "1 cup quinoa (625 kcal)",
      "15.5 oz black beans, rinsed (350 kcal)",
      "2 cups low-sodium vegetable stock",
      "2 cups kale",
      "2 medium carrots, ribbon peeled",
      "3 radishes, sliced",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Meat",
    time: "20 min", servings: 4, kcal: 279,
    macros: { p: 42, c: 4, f: 10 },
    tags: ["High protein","Low carb","Quick"],
    hero: "linear-gradient(135deg, #d99b2f 0%, #8a4a22 55%, #1a1612 100%)",
    note: "Four ingredients, one skillet, 42g of protein a chop.",
    ingredients: [
      "4 top loin pork chops (980 kcal)",
      "1/3 cup orange juice (40 kcal)",
      "2 tbsp light honey mustard dressing (60 kcal)",
      "1 tbsp reduced-sodium soy sauce",
    ],
    steps: [
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Meat",
    time: "25 min", servings: 4, kcal: 451,
    macros: { p: 29, c: 43, f: 18 },
    tags: ["High protein","Quick","One-pan"],
    hero: "linear-gradient(135deg, #b8442e 0%, #6d7a2c 55%, #1a1612 100%)",
    note: "Seared sirloin and three colours of pepper, rolled hot.",
    ingredients: [
      "12 oz sirloin steak, sliced thin (600 kcal)",
      "8 whole-wheat tortillas, 6-inch (720 kcal)",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Meat",
    time: "50 min", servings: 4, kcal: 547,
    macros: { p: 28, c: 76, f: 16 },
    tags: ["High protein","Batch","Fiber"],
    hero: "linear-gradient(135deg, #a83b23 0%, #7a5a24 55%, #1a1612 100%)",
    note: "Sweet-salty beef with olives, raisins and black beans.",
    ingredients: [
      "1 cup uncooked brown rice (680 kcal)",
      "3/4 lb lean ground beef (600 kcal)",
      "15 oz black beans, rinsed (350 kcal)",
      "14.5 oz low-sodium diced tomatoes",
      "2 cups water",
      "2 tsp vegetable oil",
      "1 onion, diced",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Poultry",
    time: "15 min", servings: 4, kcal: 301,
    macros: { p: 38, c: 22, f: 6 },
    tags: ["High protein","Quick","One-pan"],
    hero: "linear-gradient(135deg, #d4a13c 0%, #3f6b3a 55%, #1a1612 100%)",
    note: "Leftover roast turkey turned into a 15-minute wok dinner.",
    ingredients: [
      "16 oz cooked turkey, cubed (800 kcal)",
      "20 oz frozen chopped vegetables (200 kcal)",
      "1 tbsp vegetable oil (120 kcal)",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Poultry",
    time: "1 hr 5 min", servings: 4, kcal: 415,
    macros: { p: 31, c: 51, f: 9 },
    tags: ["High protein","One-pan","Family"],
    hero: "linear-gradient(135deg, #e0a53a 0%, #a8471f 55%, #1a1612 100%)",
    note: "Chicken thighs braised straight into the rice they flavour.",
    ingredients: [
      "4 chicken thighs, 6 oz each (1000 kcal)",
      "1 cup long-grain white rice (675 kcal)",
      "14.5 oz low-sodium diced tomatoes (100 kcal)",
      "2 cups water",
      "1 yellow onion, chopped",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Poultry",
    time: "1 hr 10 min", servings: 4, kcal: 181,
    macros: { p: 29, c: 8, f: 4 },
    tags: ["High protein","Low carb","Comfort"],
    hero: "linear-gradient(135deg, #b93a26 0%, #5f6b2a 55%, #1a1612 100%)",
    note: "Skinless chicken slow-simmered in oregano tomato sauce.",
    ingredients: [
      "4 pieces chicken, skin removed (600 kcal)",
      "1 cup canned tomatoes, low-sodium (80 kcal)",
      "1/2 cup tomato sauce, low-sodium (40 kcal)",
      "1 onion, chopped",
      "1 tsp oregano",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Seafood",
    time: "50 min", servings: 4, kcal: 540,
    macros: { p: 37, c: 72, f: 13 },
    tags: ["High protein","Budget","Family"],
    hero: "linear-gradient(135deg, #e8873f 0%, #c9563c 55%, #1a1612 100%)",
    note: "Canned salmon does the heavy lifting; the oven does the rest.",
    ingredients: [
      "4 large sweet potatoes (920 kcal)",
      "1 1/2 tbsp canola oil",
      "1 tbsp lemon pepper seasoning",
      "14.75 oz canned pink or red salmon (580 kcal)",
      "2 green onions, chopped",
      "1/2 cup chopped red bell pepper",
      "8 unsalted-top saltine crackers",
      "2 tsp lemon juice",
      "2 egg whites, whisked",
      "2 tbsp plain low-fat yogurt",
      "1/4 tsp ground black pepper",
      "4 whole-wheat buns (480 kcal)",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Seafood",
    time: "35 min", servings: 4, kcal: 492,
    macros: { p: 29, c: 76, f: 9 },
    tags: ["High protein","Family","Fiber"],
    hero: "linear-gradient(135deg, #d9a441 0%, #5f7a3a 55%, #1a1612 100%)",
    note: "Crisp oven-baked fish sticks with a sharp green yogurt dip.",
    ingredients: [
      "1 lb frozen pollock or cod fillets (400 kcal)",
      "1/2 cup flour",
      "2 egg whites, beaten",
      "3/4 cup whole-wheat bread crumbs (320 kcal)",
  ...
  },
  {
    ...
    ingredients: [
      "5 oz canned tuna in water, drained (180 kcal)",
      "1/3 cup low-fat mayonnaise (260 kcal)",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Vegetarian",
    time: "30 min", servings: 1, kcal: 322,
    macros: { p: 29, c: 38, f: 8 },
    tags: ["High protein","Breakfast","Fiber"],
    hero: "linear-gradient(135deg, #c8402f 0%, #6f8f3f 55%, #1a1612 100%)",
    note: "One pan, one plate, 29 grams of protein before nine.",
    ingredients: [
      "3/4 cup egg substitute (90 kcal)",
      "10 plum tomatoes, halved (110 kcal)",
      "1/2 slice whole wheat bread",
      "1/2 tsp olive oil",
      "1 clove garlic, finely chopped",
      "2 tbsp grated part-skim mozzarella (40 kcal)",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Vegetarian",
    time: "1 hr 30 min", servings: 2, kcal: 515,
    macros: { p: 29, c: 70, f: 17 },
    tags: ["High protein","Fiber","Comfort"],
    hero: "linear-gradient(135deg, #e29b3c 0%, #b06a2c 55%, #1a1612 100%)",
    note: "Roasted squash instead of tomato, ricotta instead of cream.",
    ingredients: [
      "2 1/2 cups butternut squash (200 kcal)",
      "4 oz whole wheat shell pasta (400 kcal)",
      ...
      "3/4 cup low-fat ricotta (170 kcal)",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Vegan",
    time: "2 hr 30 min", servings: 5, kcal: 334,
    macros: { p: 23, c: 55, f: 4 },
    tags: ["Fiber","Batch","Soup"],
    hero: "linear-gradient(135deg, #a8bd48 0%, #4e6a22 55%, #1a1612 100%)",
    note: "Two hours of low heat until the peas melt into the pot.",
    ingredients: [
      "2 tsp vegetable oil (80 kcal)",
      "1 Spanish onion, chopped",
      "3 carrots, chopped (75 kcal)",
      "2 celery stalks, chopped",
      "1 tsp dried thyme",
      "2 1/4 cups split peas, rinsed (1500 kcal)",
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Vegan",
    time: "25 min", servings: 4, kcal: 403,
    macros: { p: 18, c: 76, f: 4 },
    tags: ["Fiber","Pantry","Budget"],
    hero: "linear-gradient(135deg, #d98b2b 0%, #46331f 55%, #1a1612 100%)",
    note: "Black beans, sweet peppers and brown rice, built for pennies.",
    ingredients: [
      "1 tsp olive oil",
      "1 tbsp garlic, minced",
      "1 cup onion, chopped",
      "1 cup green bell pepper, diced",
      "3 cups black beans, drained (660 kcal)",
      "2 cups low-sodium vegetable broth",
      "1 tbsp vinegar",
      "1/2 tsp dried oregano",
      "to taste black pepper",
      "3 cups cooked brown rice (650 kcal)",
    ],
    steps: [
  ...
  },
  {
    ...
    by: null, byRole: null, diet: "Plant-based",
    time: "35 min", servings: 4, kcal: 382,
    macros: { p: 14, c: 45, f: 18 },
    tags: ["Fiber","GF","Side"],
    hero: "linear-gradient(135deg, #e6b23c 0%, #7c5a20 55%, #1a1612 100%)",
    note: "Bloomed curry, tender cauliflower, quinoa that soaks it up.",
    ingredients: [
      "1 cup quinoa, rinsed (620 kcal)",
      "2 tbsp olive oil (240 kcal)",
      "4 tsp curry powder",
      "1/2 tsp ground cumin",
...
const _RECIPE_ALLERGEN_NOTES = [
  ...
  ["Arroz con pollo with browned thighs", "gluten", "broth", "Commercial broth, stock and bouillon often carry wheat. Look for one labelled gluten-free", []],
  ["Split pea soup with carrot and thyme", "gluten", "broth", "Commercial broth, stock and bouillon often carry wheat. Look for one labelled gluten-free", []],
  ["Cuban black beans over brown rice", "gluten", "broth", "Commercial broth, stock and bouillon often carry wheat. Look for one labelled gluten-free", []],
  ["Curried quinoa with cauliflower and peas", "gluten", "broth", "Commercial broth, stock and bouillon often carry wheat. Look for one labelled gluten-free", []],
    ...
    <div onClick={onClose}
      ...
      <div onClick={e => e.stopPropagation()}
        ...
        <div style={{ padding: "16px 28px", borderTop: "1px solid rgba(242,237,228,0.08)", display: "flex", justifyContent: "flex-end", gap: 10 }}>
          <a href={dashShellHref("ClientLibrary.html")} style={{ background: "transparent", color: INK, border: "1px solid rgba(242,237,228,0.25)", padding: "9px 18px", borderRadius: 999, fontFamily: sans, fontSize: 13, textDecoration: "none", display: "inline-flex", alignItems: "center" }}>Save to library</a>
          <a href={dashShellHref("ClientNutri.html")} style={{ background: INK, color: PAPER, border: 0, padding: "9px 20px", borderRadius: 999, fontFamily: sans, fontSize: 13, fontWeight: 500, textDecoration: "none", display: "inline-flex", alignItems: "center" }}>Add to today's plan</a>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "260px 1fr auto", gap: 20, alignItems: "center" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <a href={dashShellHref("ClientNutri.html")} style={{ background: "transparent", color: INK, border: "1px solid rgba(242,237,228,0.2)", padding: "9px 22px", borderRadius: 999, fontFamily: sans, fontSize: 12.5, textDecoration: "none", textAlign: "center", whiteSpace: "nowrap" }}>
          See plan
        </a>
      </div>

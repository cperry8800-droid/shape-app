...
function LoginCard() {
  ...
  return (
    <div style={{
      ...
      <p style={{ fontFamily: sans, fontSize: 14, color: "rgba(242,237,228,0.6)", margin: "0 0 26px", lineHeight: 1.55 }}>Pick up where you left off. Your coaches, your plans, your progress.</p>

      {/* Role toggle — primary */}
      <div style={{ marginBottom: 26 }}>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10.5, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(242,237,228,0.55)", marginBottom: 10 }}>I'm logging in as</div>
        <div style={{ display: "flex", gap: 6, background: "rgba(15,13,12,0.6)", border: "1px solid rgba(242,237,228,0.12)", borderRadius: 999, padding: 4 }}>
          {[
            ...
            <button key={v} type="button" onClick={() => setRole(v)} style={{
              ...
              color: role === v ? "#0F0D0C" : "rgba(242,237,228,0.7)",
              border: 0,
              fontFamily: sans,
              fontSize: 13,

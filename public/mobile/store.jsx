...
const PRODUCTS = [
  ...
  { id: 2, cat: "Shape Merch", name: "Shape Crewneck", brand: "Shape Merch", cost: 780, retail: 88, img: "crewneck - bone", stock: "In stock" },
  { id: 3, cat: "Shape Merch", name: "Shape Bottle", brand: "Shape Merch", cost: 320, retail: 34, img: "bottle - black", stock: "In stock" },
  { id: 4, cat: "Shape Merch", name: "Shape Training Towel", brand: "Shape Merch", cost: 260, retail: 28, img: "towel - cream", stock: "In stock" },
  { id: 5, cat: "Shape Merch", name: "Shape Training Duffel", brand: "Shape Merch", cost: 1640, retail: 195, img: "duffel - canvas", tag: "Gold tier", stock: "In stock", locked: true },

  // Training
  { id: 6, cat: "Training", name: "$25 session credit", brand: "Training credit", cost: 500, retail: 25, img: "credit - 25", stock: "Unlimited" },
  { id: 7, cat: "Training", name: "$50 session credit", brand: "Training credit", cost: 950, retail: 50, img: "credit - 50", stock: "Unlimited" },
  { id: 8, cat: "Training", name: "Coach 2nd-opinion", brand: "Free 30-min intro", cost: 900, retail: 95, img: "intro - call", stock: "Monthly" },
  { id: 9, cat: "Training", name: "Program review", brand: "Coach audit", cost: 1200, retail: 120, img: "program - review", tag: "Popular", stock: "Unlimited" },
  ...
  { id: 11, cat: "Nutrition", name: "$25 nutrition credit", brand: "Nutrition credit", cost: 500, retail: 25, img: "credit - nutrition", stock: "Unlimited" },
  { id: 12, cat: "Nutrition", name: "Grocery list buildout", brand: "Shape nutrition", cost: 420, retail: 45, img: "grocery - list", stock: "Unlimited" },
  { id: 13, cat: "Nutrition", name: "Recipe archive pack", brand: "Shape nutrition", cost: 340, retail: 36, img: "recipes - archive", stock: "Unlimited" },

  // Shape Perks
  { id: 14, cat: "Shape Perks", name: "Shape Radio - Studio", brand: "3 months ad-free", cost: 750, retail: 36, img: "radio - studio", stock: "Unlimited" },
  { id: 15, cat: "Shape Perks", name: "Annual membership credit", brand: "$200 toward next year", cost: 3500, retail: 200, img: "annual - 200", tag: "Peak tier", stock: "Unlimited", locked: true },
];
...
function StoreHeroBg() {
  return (
    <>
      <div aria-hidden style={{ position: "absolute", inset: 0, backgroundImage: "url('assets/store-bg.png')", backgroundSize: "cover", backgroundPosition: "center center", pointerEvents: "none" }} />
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", position: "relative" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 80, alignItems: "end" }}>
          ...
          <p style={{ fontFamily: sans, fontSize: 17, lineHeight: 1.55, color: "rgba(242,237,228,0.65)", margin: 0, maxWidth: 420 }}>
            Trade Shape Score for Shape merch, training credits, nutrition services, and membership perks. No outside-company merchandise discounts.
          </p>
        </div>
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 80, alignItems: "center" }}>
        <div>
          ...
          <h2 style={{ fontFamily: serif, fontSize: 76, letterSpacing: "-0.035em", fontWeight: 400, margin: "0 0 20px", lineHeight: 0.95, color: PAPER }}>
            Shape <em style={{ fontStyle: "italic", color: TEAL }}>Merch</em><br/>training duffel.
          </h2>
          <p style={{ fontFamily: sans, fontSize: 17, lineHeight: 1.55, color: "rgba(26,22,18,0.7)", maxWidth: 460 }}>
            Gold-tier exclusive Shape merch. Water-resistant canvas, separated shoe compartment, laptop sleeve. Keep earning — 280 points to unlock.
          </p>
...
function StoreFAQ() {
  const faqs = [
    ...
    ["Who ships Shape merch?", "Shape handles fulfilment for in-house merch. Training and nutrition rewards are credited directly inside your Shape account."],

      ...
      <div style={{ padding: "0 40px 56px", position: "relative" }}>
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ paddingTop: 120, minWidth: 0 }}>
            <div style={{ fontFamily: sans, fontSize: 12, letterSpacing: "0.14em", textTransform: "uppercase", color: TEAL, marginBottom: 14, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{p.eyebrow}</div>
            <h1 style={{ fontFamily: serif, fontSize: "clamp(52px, 7.2vw, 96px)", letterSpacing: "-0.035em", fontWeight: 400, margin: 0, lineHeight: 0.95, textWrap: "balance" }}>{p.name}</h1>

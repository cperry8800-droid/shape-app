...
function CommunityHeroBg() {
  return (
    <>
      <div aria-hidden style={{ position: "absolute", inset: 0, backgroundImage: "url('assets/community-bg.png')", backgroundSize: "cover", backgroundPosition: "center 55%", pointerEvents: "none" }} />
          ...
          {list.map((e, i) => (
            <article key={i} style={{ padding: 28, background: "rgba(242,237,228,0.04)", borderRadius: 10, border: "1px solid rgba(242,237,228,0.08)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 18 }}>
                ...
                <span style={{ fontFamily: sans, fontSize: 11, padding: "4px 10px", borderRadius: 999, background: "rgba(10,197,168,0.1)", color: TEAL, letterSpacing: "0.06em" }}>{e.tag}</span>
              </div>
        ...
        <div style={{ background: "rgba(242,237,228,0.04)", border: "1px solid rgba(242,237,228,0.1)", borderRadius: 14, display: "grid", gridTemplateColumns: "260px 1fr 260px", minHeight: 540, overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ padding: 24, flex: 1, display: "flex", flexDirection: "column", gap: 14 }}>
              {r.messages.map((m, i) => (
                <div key={i} style={{ display: "grid", gridTemplateColumns: "36px 1fr", gap: 12, alignItems: "start", padding: m.highlight ? "12px 14px" : 0, background: m.highlight ? "rgba(10,197,168,0.07)" : "transparent", borderRadius: 10, border: m.highlight ? `1px solid rgba(10,197,168,0.25)` : "none" }}>

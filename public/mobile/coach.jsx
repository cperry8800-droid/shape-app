      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", position: "relative", width: "100%" }}>
        <div style={{ maxWidth: 900 }}>
          ...
          <h1 style={{ fontFamily: serif, fontSize: "clamp(56px, 8vw, 112px)", letterSpacing: "-0.035em", fontWeight: 400, margin: 0, lineHeight: 0.95, color: INK }}>
            Shape how people <em style={{ fontStyle: "italic", color: TEAL }}>train.</em>
          </h1>
...
function TrainerEarnings() {
  ...
  const FEE = 0.20;
  const gross = clients * price * 4;
  const fee = Math.round(gross * FEE);
  const monthly = gross - fee;
    ...
    <section style={{ padding: "140px 40px", background: PAPER }}>
      <div style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: 80, alignItems: "center" }}>
        <div>
          ...
          <p style={{ fontFamily: sans, fontSize: 16, color: "rgba(242,237,228,0.7)", lineHeight: 1.6, margin: "0 0 28px", maxWidth: 520 }}>
            Shape takes a flat <strong style={{ color: INK, fontWeight: 500 }}>20% platform fee</strong> on everything you earn through the app — sessions, program sales, tips, subscriptions. That's it. No tiered commissions, no per-booking add-ons, no surprise deductions.
          </p>
          <div style={{ background: "rgba(242,237,228,0.04)", border: "1px solid rgba(242,237,228,0.08)", borderRadius: 10, padding: "20px 22px", marginBottom: 32, maxWidth: 520 }}>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10.5, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(242,237,228,0.5)", marginBottom: 12 }}>What the 20% covers</div>
            <div style={{ fontFamily: sans, fontSize: 13.5, color: "rgba(242,237,228,0.72)", lineHeight: 1.65 }}>
        ...
        <div style={{ background: "rgba(242,237,228,0.04)", border: "1px solid rgba(242,237,228,0.1)", borderRadius: 14, padding: 44 }}>
          ...
          <div style={{ padding: "28px 0 0", borderTop: "1px solid rgba(242,237,228,0.1)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10, fontFamily: sans, fontSize: 13 }}>
              <div style={{ color: "rgba(242,237,228,0.55)" }}>Gross monthly</div>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", color: "rgba(242,237,228,0.8)" }}>${gross.toLocaleString()}</div>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 18, fontFamily: sans, fontSize: 13 }}>
              <div style={{ color: "rgba(242,237,228,0.55)" }}>Shape fee (20%)</div>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", color: "rgba(242,237,228,0.8)" }}>−${fee.toLocaleString()}</div>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14, paddingTop: 18, borderTop: "1px dashed rgba(242,237,228,0.12)" }}>
    ...
    <section style={{ padding: "140px 40px", background: PAPER }}>
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 48, textAlign: "center" }}>
          <a href="TrainerDashboard.html" style={{ fontFamily: sans, fontSize: 14, color: TEAL, borderBottom: "1px solid rgba(10,197,168,0.3)", paddingBottom: 3 }}>See the full dashboard →</a>
        </div>
      </div>
    </section>
  );
...
function TrainerFAQ() {
  const faqs = [
    ...
    { q: "What does Shape cost trainers?", a: "Nothing to join — no listing fees, no subscription. Shape takes a flat 20% platform fee on what you earn through the app (sessions, program sales, tips, subscriptions). That covers payment processing, the Shape marketplace, in-app messaging and video, program hosting, and liability coverage." },
    { q: "Why 20%? What does it actually cover?", a: "Roughly 3% goes to payment processing, 5% to liability insurance and platform infrastructure, and the remaining ~12% funds client acquisition through the Shape marketplace and member app — the channel that brings you new clients." },
    ...
    { q: "How do payouts work?", a: "Shape pays through Stripe. Link your existing Stripe account in under a minute during onboarding, or we'll help you spin up a new one if you don't have one — takes about five minutes and a photo of your ID. From then on it's weekly direct deposits, usually Monday." },

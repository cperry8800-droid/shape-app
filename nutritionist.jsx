    ...
    <section style={{ padding: "140px 40px", background: PAPER }}>
      <div style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: 80, alignItems: "center" }}>
        <div>
          ...
          <h2 style={{ fontFamily: serif, fontSize: "clamp(44px, 5vw, 76px)", letterSpacing: "-0.03em", fontWeight: 400, margin: "0 0 28px", lineHeight: 0.98, color: INK }}>Your rate. <em style={{ fontStyle: "italic", color: TEAL }}>Get paid weekly.</em></h2>
          <p style={{ fontFamily: sans, fontSize: 16, color: "rgba(242,237,228,0.7)", lineHeight: 1.6, margin: "0 0 28px", maxWidth: 520 }}>
            Shape takes a flat <strong style={{ color: INK, fontWeight: 500 }}>20% platform fee</strong> on everything you earn through the app — consults, meal plans, monthly retainers, one-off sessions. No tiered commissions, no per-booking add-ons.
          </p>
          <div style={{ background: "rgba(242,237,228,0.04)", border: "1px solid rgba(242,237,228,0.08)", borderRadius: 10, padding: "20px 22px", marginBottom: 32, maxWidth: 520 }}>
            ...
            <div style={{ fontFamily: sans, fontSize: 13.5, color: "rgba(242,237,228,0.72)", lineHeight: 1.65 }}>
              Payment processing, client acquisition through the Shape marketplace, in-app messaging and video, meal plan hosting, and liability coverage. One flat rate, no surprise add-ons.
            </div>
          </div>
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 14 }}>
            {["Link your existing Stripe account, or set one up in 5 minutes", "Weekly payouts direct to your bank", "Monthly retainers, consult packages, or plan-only sales"].map(t => (
        ...
        <div style={{ background: "rgba(242,237,228,0.04)", border: "1px solid rgba(242,237,228,0.1)", borderRadius: 14, padding: 44 }}>
          ...
          <div style={{ marginTop: 28, fontFamily: sans, fontSize: 11.5, color: "rgba(242,237,228,0.4)", lineHeight: 1.5 }}>
            Estimate assumes 2 billable touchpoints per client per month. Actual earnings vary by specialty and practice model.
          </div>
        </div>
      </div>
    </section>
...
function NutFAQ() {
  const faqs = [
    ...
    { q: "What does Shape cost?", a: "Nothing to join — no listing fees, no subscription. Shape takes a flat 20% platform fee on what you earn through the app (consults, meal plans, monthly retainers, tips). That covers payment processing, the Shape marketplace, in-app messaging and video, meal plan hosting, and liability coverage." },
    ...
    { q: "Payouts?", a: "Shape pays through Stripe. Link your existing Stripe account in under a minute during onboarding, or we'll help you spin up a new one if you don't have one. From then on it's weekly direct deposits to your bank." },
